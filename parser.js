var result = (function () {
  ...
  function translateInput(input) {
    input = input.replace(/@If\b/, 'IfStatement ')
    input = input.replace(/@Id\b/, 'Identifier ')
    input = input.replace(/@Var\b/, 'VariableDeclaration ')
    input = input.replace(/@Expr\b/, 'ExpressionStatement ')
    input = input.replace(/@Member\b/, 'MemberExpression ')
    input = input.replace(/@Return\b/, 'ReturnStatement ')
    input = input.replace(/@Block\b/, 'BlockStatement ')
    input = input.replace(/@ForIn\b/, 'ForInStatement ')
    input = input.replace(/@ForOf\b/, 'ForOfStatement ')
    input = input.replace(/@For\b/, 'ForStatement ')
    input = input.replace(/@Empty\b/, 'EmptyStatement ')
    input = input.replace(/@Labeled\b/, 'LabeledStatement ')
    input = input.replace(/@Break\b/, 'BreakStatement ')
    input = input.replace(/@Continue\b/, 'ContinueStatement ')
    input = input.replace(/@With\b/, 'WithStatement ')
    input = input.replace(/@Switch\b/, 'SwitchStatement ')
    input = input.replace(/@Throw\b/, 'ThrowStatement ')
    input = input.replace(/@Try\b/, 'TryStatement ')
    input = input.replace(/@While\b/, 'WhileStatement ')
    input = input.replace(/@DoWhile\b/, 'DoWhileStatement ')
    input = input.replace(/@Let\b/, 'LetStatement ')
    input = input.replace(/@This\b/, 'ThisExpression ')
    input = input.replace(/@Array\b/, 'ArrayExpression ')
    input = input.replace(/@Object\b/, 'ObjectExpression ')
    input = input.replace(/@FunDecl\b/, 'FunctionDeclaration ')
    input = input.replace(/@Fun\b/, 'FunctionExpression ')
    input = input.replace(/@Arrow\b/, 'ArrowExpression ')
    input = input.replace(/@Seq\b/, 'SequenceExpression ')
    input = input.replace(/@Cond\b/, 'ConditionalExpression ')
    input = input.replace(/@New\b/, 'NewExpression ')
    input = input.replace(/@Call\b/, 'CallExpression ')
    input = input.replace(/@Member\b/, 'MemberExpression ')
    input = input.replace(/@Yield\b/, 'YieldExpression ')
    input = input.replace(/@Gen\b/, 'GeneratorExpression ')
    input = input.replace(/@UnaryOp\b/, 'UnaryOperator ')
    input = input.replace(/@Unary\b/, 'UnaryExpression ')
    input = input.replace(/@BinaryOp\b/, 'BinaryOperator ')
    input = input.replace(/@Binary\b/, 'BinaryExpression ')
    input = input.replace(/@LogicalOp\b/, 'LogicalOperator ')
    input = input.replace(/@Logical\b/, 'LogicalExpression ')
    input = input.replace(/@AssignOp\b/, 'AssignmentOperator ')
    input = input.replace(/@Assign\b/, 'AssignmentExpression ')
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function (offset, a, b) {
            return {
              type: 'literal',
              value: parseFloat((a ? a.join('') : '') + b.join(''))
            };
          })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
